...
package com.aghajari.emojiview.samsungprovider;
...
public final class AXSamsungEmojiProvider extends AXPresetEmojiProvider {

    public AXSamsungEmojiProvider(Context context) {
    ...
    public AXSamsungEmojiProvider(Context context, int[] icons) {
        super(context, icons);
    }

    @Override
    public EmojiData getEmojiData() {
        return AXSamsungEmojiData.instance;
    }

    @Override
    protected EmojiCategory createCategory(int i, int icon) {
        return new AXSamsungEmojiCategory(i, icon, getEmojiData());
    }

    public static class AXSamsungEmojiCategory extends AXPresetEmojiCategory {
        public AXSamsungEmojiCategory(int i, int icon, EmojiData emojiData) {
            super(i, icon, emojiData);
        }

        @Override
        protected Emoji createEmoji(String code, int category, int index, EmojiData emojiData){
            return new AXSamsungEmoji(code, emojiData);
        }
    }

    public static class AXSamsungEmoji extends AXPresetEmoji {
        public AXSamsungEmoji(String code, EmojiData emojiData) {
