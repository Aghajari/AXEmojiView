...
public final class AXAppleEmojiProvider extends AXPresetEmojiProvider {

    public AXAppleEmojiProvider(Context context) {
    ...
    public AXAppleEmojiProvider(Context context, int[] icons) {
        super(context, icons);
    }

    @Override
    public EmojiData getEmojiData() {
        return AXAppleEmojiData.instance;
    }

    @Override
    protected EmojiCategory createCategory(int i, int icon) {
        return new AXAppleEmojiCategory(i, icon, getEmojiData());
    }

    public static class AXAppleEmojiCategory extends AXPresetEmojiCategory {
        public AXAppleEmojiCategory(int i, int icon, EmojiData emojiData) {
            super(i, icon, emojiData);
        }

        @Override
        protected Emoji createEmoji(String code, int category, int index, EmojiData emojiData){
            return new AXAppleEmoji(code, emojiData);
        }
    }

    public static class AXAppleEmoji extends AXPresetEmoji {
        public AXAppleEmoji(String code, EmojiData emojiData) {
