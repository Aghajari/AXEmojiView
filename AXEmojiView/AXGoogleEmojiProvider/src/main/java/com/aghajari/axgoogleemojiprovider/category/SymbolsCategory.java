...
@SuppressWarnings("PMD.MethodReturnsInternalArray") public final class SymbolsCategory implements EmojiCategory {
  private static final Emoji[] DATA = new Emoji[] {
    ...
    new Emoji(new int[] { 0x0030, 0xfe0f, 0x20e3 }, R.drawable.emoji_google_0030_fe0f_20e3),
    new Emoji(new int[] { 0x0031, 0xfe0f, 0x20e3 }, R.drawable.emoji_google_0031_fe0f_20e3),
    new Emoji(new int[] { 0x0032, 0xfe0f, 0x20e3 }, R.drawable.emoji_google_0032_fe0f_20e3),
    new Emoji(new int[] { 0x0033, 0xfe0f, 0x20e3 }, R.drawable.emoji_google_0033_fe0f_20e3),
    new Emoji(new int[] { 0x0034, 0xfe0f, 0x20e3 }, R.drawable.emoji_google_0034_fe0f_20e3),
    new Emoji(new int[] { 0x0035, 0xfe0f, 0x20e3 }, R.drawable.emoji_google_0035_fe0f_20e3),
    new Emoji(new int[] { 0x0036, 0xfe0f, 0x20e3 }, R.drawable.emoji_google_0036_fe0f_20e3),
    new Emoji(new int[] { 0x0037, 0xfe0f, 0x20e3 }, R.drawable.emoji_google_0037_fe0f_20e3),
    new Emoji(new int[] { 0x0038, 0xfe0f, 0x20e3 }, R.drawable.emoji_google_0038_fe0f_20e3),
    new Emoji(new int[] { 0x0039, 0xfe0f, 0x20e3 }, R.drawable.emoji_google_0039_fe0f_20e3),
    new Emoji(0x1f51f, R.drawable.emoji_google_1f51f),
    new Emoji(0x1f522, R.drawable.emoji_google_1f522),
    new Emoji(new int[] { 0x0023, 0xfe0f, 0x20e3 }, R.drawable.emoji_google_0023_fe0f_20e3),
    new Emoji(new int[] { 0x002a, 0xfe0f, 0x20e3 }, R.drawable.emoji_google_002a_fe0f_20e3),
    ...
    new Emoji(new int[] { 0x1f441, 0xfe0f, 0x200d, 0x1f5e8, 0xfe0f }, R.drawable.emoji_google_1f441_fe0f_200d_1f5e8_fe0f),
