...
class AXCategoryViews extends AXEmojiLayout {
    ...
    void init(){
        ...
        if (!AXEmojiManager.getEmojiViewTheme().isFooterEnabled()){
            backspace = true;
        ...
        for (int i = 0;i< categories.size();i++){
            ...
            this.addView(layout,new AXEmojiLayout.LayoutParams(left,0,size,-1));
            AppCompatImageView icon = new AppCompatImageView(getContext());
            layout.addView(icon,new AXEmojiLayout.LayoutParams
        ...
        this.addView(selection,new AXEmojiLayout.LayoutParams(
