...
final class AXEmojiVariantPopup {
  private static final int MARGIN = 2;

  @NonNull public final View rootView;
  @Nullable private PopupWindow popupWindow;

  @Nullable final onEmojiEvents listener;
  @Nullable AXEmojiImageView rootImageView;

  AXEmojiVariantPopup(@NonNull final View rootView, @Nullable final onEmojiEvents listener) {
 ...
 public boolean isShowing;
  void show(@NonNull final AXEmojiImageView clickedImage, @NonNull final Emoji emoji) {
    dismiss();
    isShowing=true;
    rootImageView = clickedImage;

    content= initView(clickedImage.getContext(), emoji, clickedImage.getWidth());
      ...
      emojiImage.setOnClickListener(new View.OnClickListener() {
        @Override public void onClick(final View view) {
          if (listener != null && rootImageView != null) {
            ...
            listener.onClick(rootImageView,false,true);
          }
        }
      });
