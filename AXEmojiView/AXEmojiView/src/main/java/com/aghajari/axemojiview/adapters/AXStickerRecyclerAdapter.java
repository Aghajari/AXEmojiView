...
public class AXStickerRecyclerAdapter extends RecyclerView.Adapter<AXStickerRecyclerAdapter.ViewHolder> {
    ...
    public AXStickerRecyclerAdapter(Sticker[] stickers, onStickerEvents events, StickerLoader loader){
        ...
        ripple.setOnClickListener(new View.OnClickListener() {
            ...
            ripple.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    if (events!=null) events.onLongClick(stickerView,sticker,false);
                    return false;
                }
            });
    }
