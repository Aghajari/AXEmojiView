...
public final class AXWhatsAppEmojiProvider extends AXPresetEmojiProvider {
    ...
    public AXWhatsAppEmojiProvider(Context context, int[] icons) {
        super(context, icons);
    }
